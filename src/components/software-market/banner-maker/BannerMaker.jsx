...
import { HomepageManageBar, HomepageAdd, BannerBox } from 'components/software-market'
        ...
        <Collapse onChange={this.onExpand}>
          <Panel showArrow={false} header={<HomepageManageBar title={title} expand={expand} />} key='1'>
            {boxList.map((item, index) => {
              return (<div className='float-box' key={index}><BannerBox title='Banner ' orderNum={item} onDelete={this.onDelete} /></div>)
            })}
